...
#### Стандартные Досткпные Функции

Для решения частных задач, с которыми вам придется столкнуться, при создании десктомных программ, существует сборники готовых "Доступных функций".

Вы можете подключать "Стандартные Досткпные Функции"(`StdAllowWbsFunc`) путем множественного наследования [-> Используйте множественное наследование для расширения доступных функций](#используйте-множественное-наследование-для-расширения-доступных-функций). Вот пример:
